...
% Calculate the model
[S,E,I1,I2,Q,H,R,D] = sir_model(sigma,beta,delta,eta1,eta2,gamma1,gamma2,lambda1,lambda2,kappa1,kappa2,Npop,I1_0,T,dt);
...
function [S,E,I1,I2,Q,H,R,D] = sir_model(sigma,beta,delta,eta1,eta2,gamma1,gamma2,lambda1,lambda2,kappa1,kappa2,Npop,I1_0,T,dt)
    S = zeros(1,T/dt);
    E = zeros(1,T/dt);
    I1 = zeros(1,T/dt);
    I2 = zeros(1,T/dt);
